...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md font-serif ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "border border-accent-2 bg-button-fill-1 text-text-1 hover:bg-button-fill-1/90",
        destructive:
          "border border-support bg-button-fill-3 text-text-1 hover:bg-button-fill-3/90",
        affirmative:
          "border border-accent-2 bg-button-fill-2 text-text-1 hover:bg-button-fill-2/90",
